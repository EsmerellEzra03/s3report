...
<div class="container-fluid">
                    ...
                    <form method="POST" action="{{route('boq:store')}}">
                        ...
                        <div>
                            ...
                            <input class="form-control" type="text" name="name" placeholder="Boq Name" value="{{ $boq->name }}">
                        </div>

                        <div>
                            <label for="quantity" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-500">Quantity</label>
                            <input class="form-control" type="text" name="quantity" placeholder="Quantity" value="{{ $boq->quantity }}">
                        </div>
